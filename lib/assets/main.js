  ...
  ctx.root.innerHTML = `
    <div class="app">
      ...
      <form>
        <div class="container">
          <div>
            <p>API Hostname: <input id="hostname" type="text" name="hostname" placeholder="Enter API hostname" /></p>
          </div>
          <div>
            <p>Token: <input id="token" type="password" name="token" placeholder="Enter your token here" /></p>
          </div>
          <div>
          ...
          <div>
            <button class="" id="refreshBtn" type="submit">Refresh</button>
            <button class="" id="createBtn" type="submit">Deploy</button>
          </div>
        </div>
      </form>
      <div>
